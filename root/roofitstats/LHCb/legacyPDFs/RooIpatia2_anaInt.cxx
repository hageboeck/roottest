...
//ClassImp(RooIpatia2AnaInt)

 RooIpatia2AnaInt::RooIpatia2AnaInt(const char *name, const char *title,
                        RooAbsReal& _x,
                        RooAbsReal& _l,
                        RooAbsReal& _zeta,
                        RooAbsReal& _fb,
 ...
 RooIpatia2AnaInt::RooIpatia2AnaInt(const RooIpatia2AnaInt& other, const char* name) :
 ...
 Double_t RooIpatia2AnaInt::evaluate() const
 { 
   Double_t d = x-mu;
 ...
 Int_t RooIpatia2AnaInt::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const
 { 
 ...
 Double_t RooIpatia2AnaInt::analyticalIntegral(Int_t code, const char* rangeName) const
 { 
   // Double_t d = x-mu;
